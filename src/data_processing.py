...
def get_strict_data(train_filename, test_filename):
    ...
    print("Loading data...")
    train_tweets = utils.load_file(path + "\\res\\datasets\\" + train_filename)
    test_tweets = utils.load_file(path + "\\res\\datasets\\" + test_filename)
...
def get_filtered_clean_data(train_filename, test_filename):
    ...
    print("Loading data...")
    train_tokens = utils.load_file(path + "\\res\\datasets\\" + train_filename)
    test_tokens = utils.load_file(path + "\\res\\datasets\\" + test_filename)
...
def get_clean_dl_data(train_filename, test_filename, word_list):
    ...
    # Load the train and test sets
    print("Loading data...")
    train_tweets = utils.load_file(path + "\\res\\tokens\\tokens_" + train_filename)
    test_tweets = utils.load_file(path + "\\res\\tokens\\tokens_" + test_filename)
...
def get_dataset(dataset):
    ...
    train_pos = utils.load_file(data_path + "\\pos\\"+"pos_train.txt")
    test_pos = utils.load_file(data_path + "\\pos\\"+"pos_test.txt")
