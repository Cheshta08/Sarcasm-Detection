...
if __name__ == "__main__":
    ...
    train_pos = utils.load_file(pos_path  + train_filename)
    test_pos = utils.load_file(pos_path + test_filename)

    # Load the labels
    train_labels = [int(l) for l in utils.load_file(path + "/res/datasets/labels_" + train_filename)]
    test_labels = [int(l) for l in utils.load_file(path + "/res/datasets/labels_" + test_filename)]
