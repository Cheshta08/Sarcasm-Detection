...
# Load the labels
y_train = [int(l) for l in utils.load_file(path + "/res/datasets/labels_" + train_filename)]
y_test = [int(l) for l in utils.load_file(path + "/res/datasets/labels_" + test_filename)]
