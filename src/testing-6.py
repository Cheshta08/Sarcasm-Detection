...
if __name__ == "__main__":
    ...
    # Clean the tweets once
    cleaned_tweets = data_proc.clean(sample_tweets)
    
    # Store the cleaned tweets in a new column
    df_cleaned['cleaned_tweets'] = cleaned_tweets

    # Preprocess the cleaned tweets and predict sarcasm
    processed_tweets = preprocess_sample_tweets(cleaned_tweets, word_to_index)
    ...
    # Save the dataframe with predictions and cleaned tweets back to Excel
